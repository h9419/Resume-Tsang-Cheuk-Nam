...
\begin{rSection}{SKILLS}
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
        Languages       & CUDA, C++, OpenMP, C#, TypeScript, JavaScript, Python, Scala, MPI, Bash       \\
        Frameworks      & React, Redux-Saga, .NET Framework, Flutter, React Native, Node.js, Platform-IO \\
        Tools           & Git, Linux, Docker, Regular Expression, LaTeX, PyTorch, CuBlas \\
...
\begin{rSection}{Work History}
    \vspace{-1.25em}
    \item \textbf{Software Developer} {Time Medical Systems Hong Kong} \hfill Jul 2023 - Present \\
    MRI Application research and development. Specialized in using CUDA to accelerate MRI image processing
